...
import { useGetAllManualDepositsQuery } from '@/redux/features/admin/adminApi';
...
const AllManualDeposits = () => {
	const { data, isLoading, isSuccess, isError, error } =
		useGetAllManualDepositsQuery(undefined);
	const { deposits } = data || [];
...
export default AllManualDeposits;
