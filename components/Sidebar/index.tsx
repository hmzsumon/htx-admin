...
import { FaFilterCircleDollar, FaUsers } from "react-icons/fa6";
        ...
        <nav className="px-4 py-4 mt-5 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/users/icm-users"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/users/icm-users" && "text-white"
                              }`}
                            >
                              ICM Users
                            </Link>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/trades/lt-profit-rate"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/trades/lt-profit-rate" &&
                                "text-green-500"
                              }`}
                            >
                              LT Profit Rate
                          ...
                          <li>
                            <Link
                              href="/trades/live-trade"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/trades/live-trade" &&
                                "text-orange-500"
                              }`}
                            >
                              Live Trade
              ...
              {/* <!--End Menu Item Notice--> */}

              {/* <!--Start Menu Item Booster --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/forms" || pathname.includes("forms")
                }
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/kyc/all-kyc"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/kyc/all-kyc" && "text-white"
                              }`}
                            >
                              All KYC
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/kyc/pending-kyc"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/kyc/pending-kyc" && "text-white"
                              }`}
                            >
                              Pending KYC
                            </Link>
